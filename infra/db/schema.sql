-- KN Biosciences Database Schema
...
CREATE TABLE IF NOT EXISTS profiles (
    ...
    last_name TEXT,
    phone TEXT,
    role TEXT DEFAULT 'customer' CHECK (role IN ('customer', 'dealer', 'distributor', 'admin')),
    company_name TEXT,
    gst_number TEXT,
    pan_number TEXT,
...
-- Product batches table (production batches)
...
-- Inventory table (warehouse stock levels)
